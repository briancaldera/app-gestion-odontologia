...
const Create = () => {
    ...
    const handleSubmit = (values: z.infer<typeof PacienteSchema>) => {
        ...
        router.post(endpoint, values, {
            onError: errors => {mapServerErrorsToFields(pacienteForm, errors);
                console.log(errors)}
        })
    }
        ...
        <AuthLayout title={'Pacientes - Registrar nuevo paciente'}>
            <Form {...pacienteForm}>
                <form onSubmit={pacienteForm.handleSubmit(handleSubmit)}
                      className={'h-full bg-white flex flex-col pl-6 pr-6 lg:pl-48 lg:pr-40'}>
                    <div className={'flex justify-between items-center pt-8 pb-10'}>
                        ...
                        <div className={'flex gap-3'}>
                            ...
                            <Button type={'submit'} className={'bg-indigo-500'} disabled={!pacienteForm.formState.isDirty || isProcessing}>Guardar</Button>
                        </div>
                    </div>
                            ...
                            <div className={'grid grid-cols-1 sm:grid-cols-2 gap-3'}>
                                ...
                                <FormField render={({field}) => (
                                    <FormItem className={'col-span-full'}>
                                        ...
                                        <FormControl>
                                            <Textarea placeholder={'Detalla los motivos de la consulta'} {...field}/>
                                        </FormControl>
                                        <FormMessage/>
                                    </FormItem>
                                ...
                                <FormField render={({field}) => (
                                    <FormItem className={'col-span-full'}>
                                        ...
                                        <FormControl>
                                            <Textarea placeholder={'Indica cualquier enfermedad que padezca el paciente al momento de la consulta'} {...field}/>
                                        </FormControl>
                                        <FormMessage/>
                                    </FormItem>
