...
const DragAndDrop = ({handleDrop = (files) => {}, ...props}) => {

    const [isdragging, setDragging] = React.useState(false)

    return (
        <Dropzone onDrop={handleDrop} onDragEnter={() => setDragging(true)} onDragLeave={() => setDragging(false)} onDropAccepted={() => setDragging(false)} onDropRejected={() => setDragging(false)} {...props}>
