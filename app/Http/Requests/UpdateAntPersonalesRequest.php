...
//            'historia_id' => ['required', 'uuid', 'exists:' . Historia::class . ',id'],
            ...
            'medicamentos' => ['sometimes', 'array:hipertensivos,analgesicos,esteroides,antidepresivos,anticonceptivos,hipogicemiante,anticonvulsivos,sildenafil,acidoacetilicidico,anticoagulante,bifosfanato,otros'],
            'medicamentos.*' => ['array:positivo,dosis_diaria'],
            'medicamentos.*.positivo' => ['boolean'],
            'medicamentos.*.dosis' => ['nullable', 'numeric', 'decimal:0,2'],

            'medicamentos.otros' => ['sometimes', 'array:positivo,descripcion'],
            'medicamentos.otros.positivo' => ['sometimes', 'boolean'],
            'medicamentos.otros.descripcion' => ['sometimes', 'nullable', 'string', 'max:255'],

            'alergias' => ['sometimes', 'array:antibioticos,analgesicos,anestesicos,yodo,otros,descripcion'],
            'alergias.*' => ['boolean'],
